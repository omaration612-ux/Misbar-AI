...
<head>
    ...
    <title>رادار مِسبار - AI RADAR</title>
    <style>
        /* تأكد من أن الجسم يغطي كامل الشاشة لضمان ظهور خلفية الجزيئات */
        html, body {
            margin: 0;
            padding: 0;
            width: 100%;
            height: 100%;
            background-color: #000; /* خلفية سوداء أساسية */
        }
    </style>
</head>
<body>
    ...
    <script>
        // الصق الكود الذي أرسلته أنت بالكامل هنا
        (function() {
            // ... (كود الجافا سكريبت الخاص بك)
            // ملاحظة: قمت بتنظيف التكرار الموجود في الكود الذي أرسلته ليعمل بسلاسة
            ...
            style.innerHTML = `
                ...
                .lang-icon { width: 24px; height: 24px; filter: invert(1); }
                ...
                .signup-link { color: #007aff; }
                .signin-link { color: #fff; }
